...
public enum BlockSide {
	...
	/**
	 * Returns the direction the entity is facing. This is intended to be used for a block's metadata on placement.
	 *
	 * @param entity
	...
	/**
	 * Returns the direction that is facing the entity This is intended to be used for a block's metadata on placement.
	 *
	 * @param entity
	 *            the entity in question
	...
	/**
	 * Returns the "native" block orientation based on side. This is a convenient function for blocks that do not rotate (with a metadata of 0).
	 *
	 * @param side
	 *            the side that is searched for.
	...
	/**
	 * Returns the direction that corresponds to side. The result is intended for a block's metadata.
	 *
	 * @param side
	 *            the side to look up.
	...
	/**
	 * Returns the direction that corresponds to this. The result is intended for a block's metadata.
	 *
