...
import net.hexogendev.api.command.defaultcmd.InfoCommand;
import net.hexogendev.api.command.defaultcmd.PluginsCommand;
import net.hexogendev.api.command.defaultcmd.ShutdownCommand;
